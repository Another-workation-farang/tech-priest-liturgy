...
def test_reserved_verbs_are_declared():
    ...
    # augur (Task 3) and transcribe (Task 4) have since graduated to real
    # subparsers, so they are no longer merely reserved.
    assert {"prove", "sanctify"} <= cli.RESERVED_VERBS
